...
def get_args_parser():
    ...
    parser.add_argument('--lr_distill', default=2e-5, type=float, help='learning rate for distillation')
    ...
    parser.add_argument('--feat-distill', action='store_true',
                        help="Train with feature distillation ")
    ...
    parser.add_argument('--dist_logit_loss_coef', default=0.2, type=float, 
                        help="loss coefficient for distillation loss")
    parser.add_argument('--dist_feat_loss_coef', default=0.01, type=float, 
                        help="loss coefficient for distillation loss")
...
def main(args):
    ...
    param_dicts = [
        ...
        {
            "params": [p for n, p in criterion.named_parameters() if "teacher" not in n and p.requires_grad],
            "lr": args.lr_distill,
        }
    ]
    if args.sgd:
